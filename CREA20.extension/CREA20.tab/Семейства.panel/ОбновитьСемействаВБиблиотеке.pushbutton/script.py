...
#     print doc_path
old_doc = False
f_template_path = str(r'\\Crea-Server\\Crea Plus\\00_РЕСУРСЫ\\01_ЦЕНТРАЛЬНАЯ_БИБЛИОТЕКА\\01_СЕМЕЙСТВА\\CP_XX_FN_Box_R22.rfa')
                            ...
                            for par_exist in fam_parameter_list:
                                ...
                                if par_new == par_exist_name:
                                    ...
                                    if storage_type == StorageType.Double:
                                        f_manager.Set(
                                        par_exist,
                                        UnitUtils.ConvertToInternalUnits(par_dict[par_new],DisplayUnitType.DUT_MILLIMETERS)
                                        )
                                    else:
                                        f_manager.Set(
                                        par_exist,
